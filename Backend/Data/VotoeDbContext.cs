...
namespace Data
{
    public class VotoeDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //Eredeti db
                var builder = new SqlConnectionStringBuilder("server=SERVERIP;database=projektmunka;user=projektmunka");

                //Teszt db
                //var builder = new SqlConnectionStringBuilder("server=SERVERIP;database=projektmunka_teszt;user=projektmunka");
